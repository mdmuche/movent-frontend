          ...
          <>
            <div className="min-h-screen bg-white pb-20">
              ...
              <section className="max-w-7xl mx-auto px-4 mt-12">
                ...
                <div className="text-gray-600 leading-relaxed space-y-4 max-w-2xl">
                  <p>
                    {event.about1.replace(
                      "{venue}",
              ...
              <section className="max-w-7xl mx-auto px-4 mt-12">
                ...
                <div className="relative rounded-[2rem] overflow-hidden h-64 md:h-96 border border-slate-200">
                  <VenueMap
                    ...
                    venueName={event.location.split(",")[0]}
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="p-6 bg-white rounded-3xl border-2 border-cyan-400 relative">
                        ...
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span className="text-xl font-black text-slate-900">
                            ${Number(event.price.split("$")[1]) * 2.5}
                          </span>
                        </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-3">
                        {event.entryRequirements.map((item, i) => (
                          <li
                            key={i}
                    ...
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-gray-500 leading-relaxed">
                        Tickets are non-refundable but can be transferred via
                        the Movent marketplace up to 24 hours before the event
                        starts.
                      </p>
                    </div>
                  </div>
